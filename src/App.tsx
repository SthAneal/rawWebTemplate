...
function App() {
  return (
    <Router>
      <Routes>
        <Route path={`/`} caseSensitive={false} element={<FrontEndProvider><Layout/></FrontEndProvider>}/>
        <Route path={`/page/*`} caseSensitive={false} element={<FrontEndProvider><Layout/></FrontEndProvider>}>
